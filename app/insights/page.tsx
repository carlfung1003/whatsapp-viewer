...
const CARDS = [
  ...
  },
  {
    ...
    title: "Birthdays",
    desc: "Birthdays inferred from past 🎂 / “happy birthday” messages. Download as .ics for your calendar.",
  },
];
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {CARDS.map((c) => (
            <li key={c.href}>
              <Link
                href={c.href}
                className="block border border-[var(--color-line)] rounded-[14px] bg-zinc-950 p-4 hover:bg-[var(--color-surface-2)] hover:border-zinc-700"
              >
